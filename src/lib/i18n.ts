...
const es = {
  ...
  archive: "Rutinas",
  archiveHint: "Protocolos de este navegador",
  archiveBase: "Como base",
  filterAll: "Todos",
  filterAthlete: "Atleta",
  filterLevel: "Nivel",
  filterKeywords: "Buscar",
  filterKeywordsPh: "Atleta, objetivo o palabra…",
  open: "Abrir",
...
• Haz los textos más simples para adultos`,
  ...
  searchRecent: "Buscar atleta, objetivo o palabra",
...
const en: { [K in keyof typeof es]: string } = {
  ...
  archive: "Routines",
  archiveHint: "Protocols in this browser",
  archiveBase: "As base",
  filterAll: "All",
  filterAthlete: "Athlete",
  filterLevel: "Level",
  filterKeywords: "Search",
  filterKeywordsPh: "Athlete, goal, or keyword…",
  open: "Open",
...
• Make the copy simpler for adults`,
  ...
  searchRecent: "Search athlete, goal, or keyword",
